      ...
      <div className="mx-auto max-w-6xl px-4 md:px-8">
        <div className="flex items-center h-16">
          ...
          <div className="flex-shrink-0">
            <a href="#hero" className="font-bold text-lg text-slate-900 dark:text-white">
              Tharaka.
            </a>
          </div>
          ...
          <div className="flex items-center gap-4">
            <a href="#contact" className="hidden md:inline-block px-4 py-2 rounded-md bg-indigo-600 text-white hover:bg-indigo-700">Hire Me</a>

            {/* Mobile menu button */}
            <div className="md:hidden">
              <button aria-label="Open menu" className="p-2 rounded-md text-slate-700 dark:text-slate-200">
