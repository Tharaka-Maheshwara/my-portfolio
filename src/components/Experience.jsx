      ...
      <div className="mx-auto max-w-6xl">
        ...
        <article className="rounded-3xl border border-slate-900 bg-slate-900/50 p-6 shadow-lg shadow-black/20 md:p-8">
          ...
          <p className="mt-5 max-w-3xl text-sm leading-7 text-slate-400 md:text-base">
            Supported software engineering work on real internal systems and
            contributed to product improvements during the internship period.
            The experience strengthened my understanding of full-stack
            development, collaboration, and delivery in a professional
            environment.
          </p>
        </article>
      </div>
