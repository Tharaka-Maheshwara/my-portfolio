      ...
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <div>
          ...
          <p className="max-w-2xl text-sm leading-7 text-slate-400 md:text-base">
            Highly motivated IT undergraduate with a strong interest in software
            engineering and a focus on building scalable web applications. I
            work mainly with the MERN stack and enjoy turning practical ideas
            into usable products.
          </p>
          <p className="mt-4 max-w-2xl text-sm leading-7 text-slate-400 md:text-base">
            I am currently looking for a Full Stack Developer opportunity where
            I can apply my development skills, contribute to real projects, and
