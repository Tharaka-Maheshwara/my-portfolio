...
const features = [
  {
    ...
    body: "I hold a high bar for code quality — every pull request is an opportunity to raise the standard. I write thorough tests, care about edge cases, and document decisions so teammates understand the why, not just the what.",
    icon: Code,
  },
  {
    title: "Systems Thinking",
    body: "Complex problems become tractable when you understand the whole system. I bring a first-principles mindset to architectural decisions, weighing long-term maintainability against delivery speed.",
    icon: Layers,
  },
  {
    title: "Collaborative Leadership",
    body: "Great software is built by great teams. I invest in pairing sessions, design reviews, and mentoring to help teams ship reliably and learn continuously.",
    icon: Users,
  },
];
...
export default function About() {
  return (
    <section
      id="about"
      className="bg-slate-50 dark:bg-slate-950 py-20 text-slate-900 dark:text-white"
    >
            ...
            <ul className="mt-6 space-y-3 text-sm text-slate-600 dark:text-slate-400">
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-slate-500">
                    Sabaragamuwa University of Sri Lanka — 2022–2026
                  </div>
                </div>
              </li>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-slate-500">
                    SLT Mobitel PLC — 03/2025–09/2025
                  </div>
                </div>
              </li>
              ...
              <li className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <div className="text-xs text-slate-500">
                    Full-Stack Development (Developers Stack), Mern Stack
                    Development (SKYREK)
                  </div>
                </div>
              </li>
